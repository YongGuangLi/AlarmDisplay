...
AlarmData::AlarmData(QObject *parent) : QObject(parent)
{
    ...
    mapAlarmLevelDesc[LEVEL_EVENT] = QString::fromUtf8("事故信号");
    mapAlarmLevelDesc[LEVEL_ABNORMAL] = QString::fromUtf8("异常信号");
    mapAlarmLevelDesc[LEVEL_OUTOFLIMIT] = QString::fromUtf8("越限信号");
    mapAlarmLevelDesc[LEVEL_CHANGE] = QString::fromUtf8("变位信号");
    mapAlarmLevelDesc[LEVEL_INFORM] = QString::fromUtf8("告知信号");
    mapAlarmLevelDesc[LEVEL_REALTIME] = QString::fromUtf8("实时信号");
}
...
QString AlarmData::getDescByAlarmLevel(int level)
{
    return mapAlarmLevelDesc[level];
}
