...
#include "ui_electricruncheck.h"

ElectricRunCheck::ElectricRunCheck(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ElectricRunCheck)
{
    ui->setupUi(this);
    ...
    connect(SingletonAlarmData, SIGNAL(receiveElectricRunCheck(stAlarmReport)), this, SLOT(dispElectricRunCheck(stAlarmReport)));
}
...
void ElectricRunCheck::dispElectricRunCheck(stAlarmReport alarmReport)
{
...
void ElectricRunCheck::showAlarmDetail(QModelIndex index)
{
