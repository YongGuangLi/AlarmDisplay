...
#include "ui_devicecomminterrupt.h"

DeviceCommInterrupt::DeviceCommInterrupt(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::DeviceCommInterrupt)
{
    ui->setupUi(this);
    ...
    connect(SingletonAlarmData, SIGNAL(receiveDeviceCommInterrupt(stAlarmReport)), this, SLOT(dispDeviceCommInterrupt(stAlarmReport)));
}
...
void DeviceCommInterrupt::dispDeviceCommInterrupt(stAlarmReport alarmReport)
{
...
void DeviceCommInterrupt::showAlarmDetail(QModelIndex index)
{
