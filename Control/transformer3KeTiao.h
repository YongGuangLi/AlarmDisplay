#ifndef TRANSFORMER3KETIAO_H
#define TRANSFORMER3KETIAO_H

#include "BaseClass.h"


class QDESIGNER_WIDGET_EXPORT transformer3KeTiao : public BaseClass
{
    Q_OBJECT
...
public:
    transformer3KeTiao(QWidget *parent = 0);
public:
    int GetApp1()const;
