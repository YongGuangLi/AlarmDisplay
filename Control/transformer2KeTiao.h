#ifndef TRANSFORMER2KETIAO_H
#define TRANSFORMER2KETIAO_H
#include "BaseClass.h"

class QDESIGNER_WIDGET_EXPORT transformer2KeTiao : public BaseClass
{
    Q_OBJECT
...
public:
    transformer2KeTiao(QWidget *parent = 0);
public:
    int GetApp1()const;
