...
#if LANG_CXX11
inline void AlarmDataMsg::set_scene(::std::string&& value) {
...
#endif
inline void AlarmDataMsg::set_scene(const char* value) {
  GOOGLE_DCHECK(value != NULL);
...
inline void AlarmDataMsg::set_scene(const char* value, size_t size) {
...
inline ::std::string* AlarmDataMsg::mutable_scene() {
...
inline ::std::string* AlarmDataMsg::release_scene() {
...
inline void AlarmDataMsg::set_allocated_scene(::std::string* scene) {
  if (scene != NULL) {
