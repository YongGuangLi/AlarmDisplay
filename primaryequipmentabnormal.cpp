...
#include "ui_primaryequipmentabnormal.h"

PrimaryEquipmentAbnormal::PrimaryEquipmentAbnormal(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PrimaryEquipmentAbnormal)
{
    ui->setupUi(this);
    ...
    connect(SingletonAlarmData, SIGNAL(receivePrimaryEquipmentAbnormal(stAlarmReport)), this, SLOT(dispPrimaryEquipmentAbnormal(stAlarmReport)));
}
...
void PrimaryEquipmentAbnormal::dispPrimaryEquipmentAbnormal(stAlarmReport alarmReport)
{
...
void PrimaryEquipmentAbnormal::showAlarmDetail(QModelIndex index)
{
