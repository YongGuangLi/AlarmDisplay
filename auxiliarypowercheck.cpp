...
#include "ui_auxiliarypowercheck.h"

AuxiliaryPowerCheck::AuxiliaryPowerCheck(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::AuxiliaryPowerCheck)
{
    ui->setupUi(this);
    ...
    connect(SingletonAlarmData, SIGNAL(receiveAuxiliaryPowerCheck(stAlarmReport)), this, SLOT(dispAuxiliaryPowerCheck(stAlarmReport)));
...
void AuxiliaryPowerCheck::dispAuxiliaryPowerCheck(stAlarmReport alarmReport)
{
...
void AuxiliaryPowerCheck::showAlarmDetail(QModelIndex index)
{
